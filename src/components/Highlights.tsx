  ...
  const highlights = [
    {
      ...
      description: "Produtos certificados que atendem às normas técnicas mais rigorosas",
      color: "from-blue-500 to-blue-600",
    },
    {
      icon: <Rocket className="h-10 w-10" />,
      title: "Tecnologia Avançada",
      description: "Equipamentos modernos para fabricação de alta precisão",
      color: "from-orange-500 to-orange-600",
    },
    {
      icon: <CheckCircle className="h-10 w-10" />,
      title: "Entrega no Prazo",
      description: "Comprometimento com cronogramas e prazos estabelecidos",
      color: "from-green-500 to-green-600",
    },
    {
      icon: <Lightbulb className="h-10 w-10" />,
      title: "Soluções Personalizadas",
      description: "Desenvolvimento de produtos especiais sob medida",
      color: "from-yellow-500 to-yellow-600",
    },
    {
      icon: <Heart className="h-10 w-10" />,
      title: "Atendimento Dedicado",
      description: "Suporte técnico especializado em todas as etapas",
      color: "from-pink-500 to-pink-600",
    },
    {
      icon: <Star className="h-10 w-10" />,
      title: "Fabricação Nacional",
      description: "Produção 100% brasileira com os melhores materiais",
